...
class DownloadsController extends Controller
{
    public function getDataByState($state = null)
    {
        if ($state) {
            ...
            Excel::create('Open Litter Map', function ($excel) use ($state): void {

                $excel->sheet('OLM', function ($sheet) use ($state): void {
    ...
    public function getDataByCountry($country)
    {
        // Country only
        // need to pass the variable down the chain
        Excel::create('Open Litter Map', function ($excel) use ($country): void {

            $excel->sheet('OLM', function ($sheet) use ($country): void {
    ...
    public function getDataByCity($country, $state, $city)
    {
        if ($city) {
            // City only
            // need to pass the variable down the chain
            Excel::create('Open Litter Map', function ($excel) use ($city): void {
                $excel->sheet('OLM', function ($sheet) use ($city): void {
