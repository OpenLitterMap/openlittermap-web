<template>
    ...
    <div class="column is-3">
        ...
        <!-- Location metadata -->
        <div class="panel">
            <div class="panel-block">{{ $t('location.total-verified-litter') }}: <strong class="green">&nbsp; {{ location['total_litter_redis'].toLocaleString() }}</strong></div>
            <div class="panel-block">{{ $t('location.total-verified-photos') }}: <strong class="green">&nbsp; {{ location['total_photos_redis'].toLocaleString() }}</strong></div>
