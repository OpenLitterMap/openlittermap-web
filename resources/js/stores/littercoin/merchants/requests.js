export const requests = {
     ...
     * Admin only
     */
    async GET_NEXT_MERCHANT_TO_APPROVE ()
    {
     ...
     */
    async DELETE_MERCHANT ()
    {
        // const title = i18n.t('notifications.success');
        // const body = 'Merchant deleted';

        await axios.post('/admin/merchants/delete', {
            merchantId: this.merchant.id, // context.state.merchant.id
        })
        .then(response => {
