                        ...
                        <form @submit.prevent="submit" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="relative">
                                    <span
                                        ...
                                        :style="{ color: activeField === 'username' ? 'rgba(16,185,129,0.8)' : 'rgba(107,114,128,0.4)' }"
                                        aria-hidden="true"
                                    >
                            ...
                            <div class="mb-3">
                                ...
                                <div class="relative">
                                    <span
                                        class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3"
                                        :style="{ color: activeField === 'email' ? 'rgba(16,185,129,0.8)' : 'rgba(107,114,128,0.4)' }"
                                        aria-hidden="true"
                                    >
                            ...
                            <div class="mb-3">
                                ...
                                <div class="relative">
                                    <span
                                        class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3"
                                        :style="{ color: activeField === 'password' ? 'rgba(16,185,129,0.8)' : 'rgba(107,114,128,0.4)' }"
                                        aria-hidden="true"
                                    >
                                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path
