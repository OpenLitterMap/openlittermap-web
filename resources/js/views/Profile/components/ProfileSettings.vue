<template>
    <div class="space-y-6">
        ...
        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div class="space-y-4">
                <SettingsField label="Name" :value="name" @save="(v) => saveSetting('name', v)" />
                <SettingsField label="Username" :value="username" @save="(v) => saveSetting('username', v)" />
                <SettingsField label="Email" :value="email" type="email" @save="(v) => saveSetting('email', v)" />
            </div>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div class="space-y-3">
                ...
                />
                <SettingsToggle
                    label="Show Previous Tags"
                    description="Pre-fill tags from your last upload"
                    :value="userStore.user.previous_tags"
                    @toggle="settingsStore.TOGGLE_PRIVACY('/api/settings/privacy/toggle-previous-tags')"
                />
                <SettingsToggle
                    label="Email Notifications"
                    description="Receive email updates about your contributions"
        ...
        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <div class="space-y-3">
                ...
                />
                <SettingsToggle
                    label="Show username on leaderboards"
        ...
        <div class="bg-red-500/5 border border-red-500/20 rounded-xl p-6">
            ...
            <p class="text-white/40 text-sm mb-4">
                Permanently delete your account. Your photos will remain as public contributions to the map.
            </p>
            <button
            ...
            <div v-else class="space-y-3">
                ...
                <div class="flex gap-3">
                    <button
                        ...
                        @click="confirmDelete"
                    >
                        {{ settingsStore.deleting ? 'Deleting...' : 'Confirm Delete' }}
                    </button>
                    <button
