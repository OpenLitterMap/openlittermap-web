<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-emerald-900">
        <!-- Header -->
        ...
        <div class="bg-white/5 border-b border-white/10">
            <div class="max-w-4xl mx-auto flex">
                ...
                >
                    ...
                    <span
                        v-if="tab.badge"
                        class="ml-1.5 inline-flex items-center px-1.5 py-0.5 text-xs font-medium rounded-full bg-emerald-500/20 text-emerald-400"
                    >
                        {{ tab.badge }}
                    </span>
                </button>
        ...
        <div class="max-w-4xl mx-auto px-4 py-6">
            ...
            <div v-if="activeTab === 'upload'">
                <div class="bg-white/5 border border-white/10 rounded-xl p-6">
                    <h2 class="text-lg font-semibold text-white mb-4">Upload a Photo</h2>

                    <div
                        class="border-2 border-dashed border-white/20 rounded-lg p-8 text-center hover:border-emerald-500/40 transition-colors cursor-pointer"
                    ...
                    <button
                        ...
                        :class="uploading ? 'bg-white/10 text-white/30 cursor-not-allowed' : 'bg-emerald-500 hover:bg-emerald-400'"
                        @click="uploadPhoto"
                    >
                    ...
                    <p v-if="uploadSuccess" class="text-emerald-400 text-sm mt-2">Photo uploaded! Go to My Photos to tag it.</p>
                </div>
            </div>
                        ...
                        <div class="p-3 space-y-2">
                            ...
                            <div class="flex gap-2">
                                <button
                                    ...
                                    class="text-xs px-2 py-1 text-emerald-400 border border-emerald-500/20 rounded hover:bg-emerald-500/10 flex-1 transition-colors"
                                ...
                                <button
                                    ...
                                    class="text-xs px-2 py-1 text-red-400 border border-red-500/20 rounded hover:bg-red-500/10 transition-colors"
