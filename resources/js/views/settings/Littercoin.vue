<template>
    <div>
        <h1 class="title is-4">
            {{ $t('settings.littercoin.littercoin-header') }}
        </h1>
        <hr>
        <div>
            <p v-if="true">
                {{ $t('settings.littercoin.back-later') }}
            </p>
            ...
            <div v-else>
                    ...
                    <div class="columns">
                        <div class="column is-half">
                            ...
                            <div v-if="this.user.eth_wallet">
                                ...
                                <br>
                                <button class="button is-medium is-danger" @click="deleteWallet">
                                    Delete wallet ID
                                </button>
                            </div>
                            <div v-else>
                                <form method="POST" action="/settings/littercoin/" role="form" @submit.prevent="addWallet">
                                    <input id="user-wallet-id" v-model="userwallet" name="user-wallet-id" type="text" class="input" placeholder="Your Wallet ID">
                                    <br>
                                    <br>
                ...
                <div v-else>
                    <div v-if="this.user.eth_wallet">
                        ...
                        <br>
                        <h1 class="title is-3">
                            My Ethereum: <span id="mybal" />
                        </h1>
                        <h1 class="title is-3">
                            My Littercoin: <span id="myLtrx" />
                        </h1>
                        <br>
                        ...
                        <div class="input-group">
                            ...
                            <input v-model="inputltrx" type="text" class="input" placeholder="Insert wallet ID here to send LTRX" size="50">
                        </div>
                        <div class="input-group">
                            <span id="sizing-addon2" class="input-group-addon">
                                <span><strong>LTRX</strong></span>
                            </span>
                            <input v-model="amountltrx" type="text" class="input" placeholder="Insert amount of LTRX to send eg 1.0000" size="50">
                        </div>
                        <br>
                        <button id="sendcoinbutton" class="button is-medium is-success" @click="sendltrx">
                            Send LTRX
                        </button>
                        <button class="button is-medium is-danger" @click="deleteWallet">
                            Delete wallet ID
                    ...
                    <div v-else>
                        <div class="column one-third is-offset-1" style="padding-left: 2em; padding-right: 2em;">
                            ...
                            <p style="color: grey;">
                                0xDA99A3329362220d7305e4C7071F7165abC34181
                            </p>
                            <br>
                            <form method="POST" action="/settings/littercoin/" role="form" @submit.prevent="addWallet">
